            ...
            <div class="col-xs-12 col-sm-9">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br>
                            <h3><span class="label label-default">Ingreso</span></h3>
                            <?php
                                if(!isset($conexion)){
                                    include("conexion.php");
                                } 
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <br>
                            <h3><span class="label label-danger">Gasto</span></h3>
                            <?php
                                if(!isset($conexion)){
                                    include("conexion.php");
                                } 
                                $consulta = "SELECT * FROM cuentas WHERE codigo_cuenta LIKE '5%'";
