	...
	<div class="modal fade" id="creditos" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						Este sistema ha sido desarrollado por un equipo de 2 programadores. A continuación se detallan sus nombres:
						<br><br>
					</p>
					<ol>
						<li><b>Dimas Gallegos Eileen Alessia </b></li>
						<li><b>Murgas Hernandez Fernando David</b></li>
